...
export const translations = {
  en: {
    ...
    requestPleasure: "request the pleasure of your company at this special celebration",
    subHeadlineLabel: "Welcome message (under names)",
    subHeadlinePlaceholder: "request the pleasure of your company at this special celebration",
    ...
    messagePlaceholder: "A short note for the host…",
  ...
  ar: {
    ...
    requestPleasure: "يطلبان شرف حضوركم لمشاركتهم هذه المناسبة الخاصة",
    subHeadlineLabel: "رسالة الترحيب (تحت الأسماء)",
    subHeadlinePlaceholder: "يطلبان شرف حضوركم لمشاركتهم هذه المناسبة الخاصة",
    ...
    messagePlaceholder: "كلمة قصيرة للمضيف…",
