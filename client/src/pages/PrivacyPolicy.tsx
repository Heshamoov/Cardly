...
const SECTIONS = {
  en: {
    ...
    items: [
      { h: "1. Introduction", p: "Cardly (\"we\", \"us\", \"our\") is committed to protecting your personal information. This Privacy Policy explains what data we collect, how we use it, and your rights." },
      ...
      { h: "5. Data Retention", p: "Your invitation data is retained for as long as your account is active. You may request deletion of your data at any time by contacting us at support@cardly.app. Guest RSVP data is retained for 12 months after the event date, after which it is automatically deleted." },
      { h: "6. Cookies", p: "We use a single session cookie to keep you signed in. We do not use advertising or tracking cookies." },
      { h: "7. Your Rights", p: "You have the right to: access the personal data we hold about you; correct inaccurate data; request deletion of your data; and withdraw consent at any time. To exercise these rights, contact us at support@cardly.app." },
      ...
      { h: "11. Contact", p: "For privacy-related questions, contact us at support@cardly.app." },
    ],
  ...
  ar: {
    ...
    items: [
      { h: "١. المقدمة", p: "تلتزم Cardly («نحن»، «لنا»، «خاصتنا») بحماية معلوماتك الشخصية. توضح سياسة الخصوصية هذه البيانات التي نجمعها وكيفية استخدامها وحقوقك." },
      ...
      { h: "٥. الاحتفاظ بالبيانات", p: "يتم الاحتفاظ ببيانات دعوتك طالما حسابك نشط. يمكنك طلب حذف بياناتك في أي وقت بالتواصل معنا على support@cardly.app. يتم الاحتفاظ ببيانات RSVP للضيوف لمدة ١٢ شهرًا بعد تاريخ الحفل، وبعدها تُحذف تلقائيًا." },
      ...
      { h: "٧. حقوقك", p: "لديك الحق في: الوصول إلى البيانات الشخصية التي نحتفظ بها عنك؛ وتصحيح البيانات غير الدقيقة؛ وطلب حذف بياناتك؛ وسحب الموافقة في أي وقت. لممارسة هذه الحقوق، تواصل معنا على support@cardly.app." },
      ...
      { h: "١١. التواصل", p: "للاستفسارات المتعلقة بالخصوصية، تواصل معنا على support@cardly.app." },
    ],
