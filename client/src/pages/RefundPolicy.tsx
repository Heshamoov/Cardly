...
const SECTIONS = {
  en: {
    ...
    items: [
      { h: "1. Overview", p: "We want you to be completely satisfied with Cardly. This Refund Policy explains the circumstances under which refunds are available for our monthly subscription service." },
      ...
      { h: "5. How to Request a Refund", p: "To request a refund, email us at support@cardly.app with your registered email address, a description of the issue, and the date of the charge. We will respond within 2 business days." },
      ...
      { h: "8. Contact", p: "For refund enquiries, contact us at support@cardly.app." },
    ],
  ...
  ar: {
    ...
    items: [
      { h: "١. نظرة عامة", p: "نريدك أن تكون راضيًا تمامًا عن Cardly. توضح سياسة الاسترداد هذه الظروف التي يمكن فيها الحصول على استردادات لخدمة الاشتراك الشهري." },
      ...
      { h: "٥. كيفية طلب الاسترداد", p: "لطلب استرداد، أرسل بريدًا إلكترونيًا إلى support@cardly.app مع عنوان بريدك الإلكتروني المسجل ووصف المشكلة وتاريخ الرسوم. سنرد خلال يومي عمل." },
      ...
      { h: "٨. التواصل", p: "للاستفسار عن الاستردادات، تواصل معنا على support@cardly.app." },
    ],
